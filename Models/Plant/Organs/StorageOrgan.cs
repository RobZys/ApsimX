namespace Models.PMF.Organs
{
    ...
    /// <summary>
    /// This organ is simulated using a generic organ type a more sink like storage.
    /// </summary>
    [Serializable]
    [Description("Storage organ Class")]
    [ViewName("UserInterface.Views.GridView")]
    [PresenterName("UserInterface.Presenters.PropertyPresenter")]
    [ValidParent(ParentType = typeof(Plant))]
    public class StorageOrgan : Model, IOrgan, IArbitration, ICustomDocumentation, IRemovableBiomass
    {
